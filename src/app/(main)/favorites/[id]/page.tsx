...
export default function FavoriteShowPage() {
  ...
  const ytVideoId = urlType === "youtube" ? extractYouTubeId(musicUrl!) : null;
  ...
  return (
    <Layout className="px-0 md:px-0 pt-0 md:pt-0">
      <div className="min-h-screen bg-background">
        ...
        <main className="flex flex-wrap md:flex-nowrap px-6 gap-4 py-4 md:py-6 pb-16">
                ...
                {showJourney && (
                  <section className="rounded-xl border border-white/5 bg-card/40 p-4 2xl:mb-6 mb-4">
                    <EmotionalJourneyView
                      ...
                      momentPins={
                        Array.isArray(fields.momentPins)
                          ? fields.momentPins
                          : []
                      }
                      className="mt-1"
