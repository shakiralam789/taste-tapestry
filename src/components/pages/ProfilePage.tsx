          ...
          <div className="flex flex-col lg:flex-row md:gap-6 gap-4 items-start">
            ...
            <div className="flex-1 w-full space-y-4 sm:space-y-6 pt-8 lg:pt-0">
              ...
              <div className="w-full">
                <div className="bg-background/80 backdrop-blur-sm sticky sm:top-16 top-12 z-10 w-full flex items-center justify-between sm:justify-start flex-wrap border-b border-white/10 p-0 h-auto rounded-none mb-8 gap-4">
                  {PROFILE_TABS.map((tab) => (
                    ...
                    >
                      <span className="block sm:hidden px-6"><tab.icon className="w-4 h-4" /></span>
