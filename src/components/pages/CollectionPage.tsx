            ...
            <div className="min-h-screen py-8 sm:px-4">
                <div className="container mx-auto px-4">
                    ...
                    <Tabs
                        ...
                        className="w-full"
                    >
                        <TabsList className="bg-background/80 backdrop-blur-sm sticky top-12 sm:top-16 z-10 w-full justify-start flex-wrap border-b border-white/10 p-0 h-auto rounded-none gap-0">
