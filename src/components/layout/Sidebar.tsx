      ...
      >
        <div className="relative group">
          ...
          <Input
            ...
            className="pl-10 pr-4 h-10 bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 text-foreground focus:border-primary/50 border focus:ring-primary/20 rounded-full transition-all"
          />
