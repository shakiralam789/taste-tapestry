...
export function CommentItem({ comment, onReply, onReact, depth = 0 }: CommentItemProps) {
    ...
    return (
        <div className={cn("flex flex-col gap-3 py-4", depth > 0 && "ml-8 border-l border-border pl-4")}>
            <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-muted-foreground">
                        ...
                        >
                            <Heart className={cn("w-3.5 h-3.5", myReaction === "❤️" && "fill-current")} />
                        ...
                        <button className="flex items-center gap-1 text-[11px] font-medium transition-colors hover:text-primary ml-auto opacity-0 group-hover:opacity-100">
